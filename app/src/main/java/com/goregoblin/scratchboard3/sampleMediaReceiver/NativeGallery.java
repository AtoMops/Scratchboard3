 ...
 *
 * from here:
    https://github.com/yasirkula/UnityNativeGallery/tree/670d9e2b8328f7796dd95d29dd80fadd8935b804


 * --> it shows how to save stuff by using MediaStore
 *      also different API's are taken into account
 *
 *      maybe we should have a look on the whole project and learn something oO'
 *
 *
 */
